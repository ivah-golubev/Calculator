...
public partial class MainWindow : Window
{
    ...
    public void AddDigit(object digit, RoutedEventArgs e){
        ...
        if(Operations.Text[Operations.Text.Length - 1] != '²' && Operations.Text.Length < 16){
    ...
    public void AddPower(object power, RoutedEventArgs e){
        if (Operations.Text.Length != 1 && Operations.Text[Operations.Text.Length - 1] != '√' && Operations.Text[Operations.Text.Length - 1] != '²' && Operations.Text[Operations.Text.Length - 1] != '.' && Operations.Text[Operations.Text.Length - 1] != '\x20' && Operations.Text.Length < 16){
            Operations.Text += '²';
        }
    }

    public void AddSqrt(object sqrt, RoutedEventArgs e){
        if (Operations.Text.Length == 1 || (Operations.Text[Operations.Text.Length - 1] == '\x20' && Operations.Text.Length < 16)){
            Operations.Text += '√';
        }
    }

    public void AddPoint(object point, RoutedEventArgs e){
        if(Operations.Text.Length != 1 && Operations.Text[Operations.Text.Length - 1] != '.' && Operations.Text[Operations.Text.Length - 1] != '\x20' && Operations.Text[Operations.Text.Length - 1] != '²' && Operations.Text[Operations.Text.Length - 1] != '√' && Operations.Text.Length < 16){
            Operations.Text += '.';
        }
    }
    ...
    public void Calculate(object calc, RoutedEventArgs e){
            if (Operations.Text.Length != 1 && Operations.Text[Operations.Text.Length - 1] != '\x20' && Operations.Text[Operations.Text.Length - 1] != '√' && Operations.Text[Operations.Text.Length - 1] != '.'){
                ...
                if (!Error){
                    ...
                    int round = 14 - Math.Ceiling(result).ToString().Length > 0 ? 14 - Math.Ceiling(result).ToString().Length : 0;
                    Result.Text = "ㅤ" + Math.Round(result, round).ToString().Replace(',', '.');
                } else {
                    Result.Text = "ㅤ" + "ERROR";
                }
